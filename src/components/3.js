!function(e, t) {
    ...
    return function(e) {
        ...
        function l(e, t) {
            ...
            d.IS_X5TBS && e.x5_player ? w.mobile = ["flv", "m3u8", "mp4"] : d.IS_ENABLED_MSE && e.h5_flv && (w.mobile = ["flv", "m3u8", "mp4"])) : (e.flash = !(void 0 != e.flash && !t.isFormat("rtmp")) || e.flash,
            e.flash ? (!d.IS_ENABLED_FLASH || d.IS_MAC && d.IS_SAFARI) && (e.flash = !1,
            d.IS_ENABLED_MSE ? e.h5_flv && (d.IS_SAFARI && v.compareVersion(d.SAFARI_VERSION, "10.1") > -1 || !d.IS_SAFARI) ? w.pc = ["flv", "m3u8", "mp4"] : w.pc = ["m3u8", "mp4"] : w.pc = ["mp4"]) : d.IS_ENABLED_MSE ? e.h5_flv && (d.IS_SAFARI && v.compareVersion(d.SAFARI_VERSION, "10.1") > -1 || !d.IS_SAFARI) ? w.pc = ["flv", "m3u8", "mp4"] : w.pc = ["m3u8", "mp4"] : !d.IS_ENABLED_FLASH || d.IS_MAC && d.IS_SAFARI ? w.pc = ["mp4"] : e.flash = !0),
            e.clarity) {
    ...
    , function(e, t, i) {
        ...
        function a(e) {
            ...
            p.__isFullscreen || m.off(document, S.fullscreenchange, a),
            b.pub({
        ...
        function c(e, t) {
            ...
            "webkitbeginfullscreen" == e.type ? (m.on(t.video.el, "webkitendfullscreen", function(e) {
                c(e, t)
            }),
            b.pub({
                type: g.MSG.FullScreen,
            ...
            }, p.player)) : "webkitendfullscreen" == e.type && (m.off(t.video.el, "webkitendfullscreen", c),
            b.pub({
                type: g.MSG.FullScreen,
                src: "util",
                ts: e.timeStamp,
        ...
        function p(e, t, i) {
            ...
            p.player = e,
            S.requestFullscreen ? t ? (m.on(document, S.fullscreenchange, a),
            i && i[S.requestFullscreen]()) : document[S.exitFullscreen]() : o && e.video.el.webkitEnterFullScreen ? (m.on(e.video.el, "webkitbeginfullscreen", function(t) {
                c(t, e)
            }),
            ...
            m.on(document, "keydown", u)) : (document.documentElement.style.overflow = p.__origOverflow,
            m.off(document, "keydown", u)),
            m.toggleClass(document.body, "vcp-full-window", t),
            b.pub({
                type: g.MSG.FullScreen,
                src: "util",
                detail: {
        ...
        t.compareVersion = f,
        t.escapeHTML = y;
        for (var v = i(2), m = o(v), g = i(4), b = o(g), _ = i(1), w = (o(_),
        1), S = t.FullscreenApi = {
    ...
    , function(e, t, i) {
        ...
        t.Player = function() {
            function e(t) {
                ...
                this.ready = !1;
                var i = t.owner;
                return i ? (this.guid = C.guid(),
                this.listener = this.options.listener,
                d.sub("*", "*", C.bind(this, this.handleMsg), this),
                i = x.get(i),
            ...
            return e.prototype.render = function(e) {
                ...
                if (!this.video)
                    return C.console.error("create video failed");
                this.poster = new E["default"](this),
                this.poster.render(this.el),
                (T.IS_SAFARI && parseInt(T.SAFARI_VERSION) > 10 || T.IOS_VERSION > 10) && "system" == this.options.controls || (this.bigplay = new w["default"](this),
                ...
                n && (this.panel = new b["default"](this),
            ...
            e.prototype.setup = function() {
                if (this.__handleEvent = C.bind(this, this.handleEvent),
                T.IS_MOBILE) {
            ...
            e.prototype.handleMsg = function(e) {
                ...
                case I.Play:
                    ...
                    this.video.type() == C.VideoType.RTMP && (this.__wait = !0,
                    this.loading.show()),
    ...
    , function(e, t, i) {
        ...
        function c(e, t) {
            ...
            if (t.singleton) {
                ...
                e.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (i = a(t),
                o = h.bind(null, i),
                n = function() {
                    s(i),
          ...
          , _ = (f.FullscreenApi,
        {
          ...
          , w = function(e) {
            ...
            t.prototype.render = function(t) {
                ...
                return i = o.poster && "object" == a(o.poster) ? o.poster.src : "string" == typeof o.poster ? o.poster : null,
                this.createEl("video", {
                    controls: n,
                    preload: o.preload || "auto",
                    autoplay: r,
            ...
            t.prototype.load = function(e, t) {
                ...
                var i = e.indexOf(".m3u8") > -1 || t == f.VideoType.M3U8
                  , o = e.indexOf(".flv") > -1;
                if (!b.IS_ENABLED_MSE || !i && !o || b.IS_X5TBS && this.player.options.x5_player || i && b.IS_MAC && b.IS_SAFARI && !b.IS_IOS)
                    this.__type = t,
                    this.el.src = e;
                else {
                    var n = this
          ...
          , y = function() {
            ...
            e.prototype.on = function(e, t, i) {
                ...
                var o = s(this.guid, i)
                  , n = !o
                  , l = o && !this.fnCache[o];
                return n || l ? (i = u.bind(this, i, this.guid),
                ...
                this.cbs) {
                    for (var e in this.cbs)
                        if (this.cbs.hasOwnProperty(e)) {
                            var t = this.cbs[e];
                            a.off(t.el, t.type, this.fnCache[t.guid]),
                            delete this.cbs[e]
                        }
                    this.fnCache = null,
                    this.cbs = null;
            ...
            t.prototype.notify = function(e, t) {
                ...
                try {
                    ...
                    case "netStatus":
                        ...
                        this.__prevPlayState = null) : "NetStream.Seek.Complete" == t.code),
        ...
        var a = i(11)
          ...
          , C = function(e) {
            ...
            t.prototype.render = function(t) {
                ...
                this.timelabel = new g["default"](this.player),
    ...
    , function(e, t, i) {
        ...
        i(3))
          ...
          , y = function(e) {
            ...
            ,
            t.prototype.setup = function() {
                this.enabled && (this.sub(a.MSG.Changing, this.progress, f.bind(this, this.handleMsg)),
                this.sub(a.MSG.Changed, this.progress, f.bind(this, this.handleMsg)))
            }
            ,
            t.prototype.handleMsg = function(e) {
                e.type === a.MSG.Changing ? (this.scrubbing = !0,
                this.syncLabel(this.percent())) : e.type === a.MSG.Changed && (this.scrubbing = !1)
            }
            ,
    ...
    , function(e, t, i) {
        ...
        var a = i(17)
          ...
          , m = function(e) {
            ...
            ,
            t.prototype.setup = function() {
                this.sub(a.MSG.Changing, this.volume, y.bind(this, this.handleMsg)),
                this.sub(a.MSG.Changed, this.volume, y.bind(this, this.handleMsg)),
        ...
        !function(e, t) {
            ...
            function i(e, t, i, o) {
                var n = ["opacity", t, ~~(100 * e), i, o].join("-")
                  ...
                  , a = l && "-" + l + "-" || "";
                return h[n] || (u.insertRule("@" + a + "keyframes " + n + "{0%{opacity:" + s + "}" + r + "%{opacity:" + e + "}" + (r + .01) + "%{opacity:1}" + (r + t) % 100 + "%{opacity:" + e + "}100%{opacity:" + s + "}}", u.cssRules.length),
                h[n] = 1),
                n
            }
            function o(e, t) {
            ...
            function a() {
                ...
                l.prototype.lines = function(e, o) {
                    ...
                    var a, c = o.scale * (o.length + o.width), u = 2 * o.scale * c, p = -(o.width + o.length) * o.scale * 2 + "px", h = n(r(), {
                        position: "absolute",
                        top: p,
                        left: p
                    });
                    if (o.shadow)
                        for (a = 1; a <= o.lines; a++)
                            l(a, -2, "progid:DXImageTransform.Microsoft.Blur(pixelradius=2,makeshadow=1,shadowopacity=.3)");
                    for (a = 1; a <= o.lines; a++)
                        l(a);
                    return t(e, h)
                }
            ...
            r(l.prototype, {
                spin: function(t) {
                    ...
                    t && t.insertBefore(r, t.firstChild || null),
                    r.setAttribute("role", "progressbar"),
                    i.lines(r, i.opts),
                    !c) {
                        var s, l = 0, a = (o.lines - 1) * (1 - o.direction) / 2, u = o.fps, p = u / o.speed, h = (1 - o.opacity) / (p * o.trail / 100), d = p / o.lines;
                        !function f() {
                            l++;
                            for (var e = 0; e < o.lines; e++)
                                s = Math.max(1 - (l + (o.lines - e) * d) % p * h, o.opacity),
                                i.opacity(r, e * o.direction + a, s, o);
